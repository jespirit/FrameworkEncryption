...
namespace System.Web.Security.Cryptography {
    using MachineKeyEncrypt;
    //using MachineKeyEncrypt.Resources;
    using System;
    ...
    public sealed class MachineKeyMasterKeyProvider : IMasterKeyProvider {
        ...
        private readonly IMachineKeySectionMinimal _machineKeySection;
        private CryptographicKey _validationKey;

        public MachineKeyMasterKeyProvider(IMachineKeySectionMinimal machineKeySection)
        {
        ...
        internal MachineKeyMasterKeyProvider(IMachineKeySectionMinimal machineKeySection, string applicationId = null, string applicationName = null, CryptographicKey autogenKeys = null, KeyDerivationFunction keyDerivationFunction = null) {
            _machineKeySection = machineKeySection;
        ...
        internal CryptographicKey AutogenKeys {
            get {
                if (_autogenKeys == null) {
                    _autogenKeys = new CryptographicKey(AutoGenKeys.s_autogenKeys);
                }
                return _autogenKeys;
            }
        }
