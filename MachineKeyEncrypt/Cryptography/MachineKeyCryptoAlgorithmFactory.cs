...
namespace System.Web.Security.Cryptography {
    ...
    public sealed class MachineKeyCryptoAlgorithmFactory : ICryptoAlgorithmFactory {
        ...
        public MachineKeyCryptoAlgorithmFactory(IMachineKeySectionMinimal machineKeySection) {
...
#pragma warning restore 618
        ...
        private Func<KeyedHashAlgorithm> GetValidationAlgorithmFactory() {
            return GetGenericAlgorithmFactory<KeyedHashAlgorithm>(
                ...
                // switchStatement lambda returns KeyedHashAlgorithm
                switchStatement: algorithmName => {
                    switch (algorithmName) {
                        case "SHA1":
