...
// MVID: 5F8CC127-2711-447E-AB4E-B3772D757FC8
...
//namespace MachineKeyEncrypt.Resources
//{
  internal sealed class SR
  {
    ...
    //internal SR() => this.resources = new ResourceManager("System.Web", this.GetType().Assembly);

    // resgen System.Web.txt -> System.Web.resources
    internal SR() {
        // FIXME: MissingManifestResourceException
        // FIX: Specify the basename: <assembly>.<folder>.<filename>
        this.resources = new ResourceManager("MachineKeyEncrypt.Resources.System.Web", this.GetType().Assembly);
    }
